...
<head>
    ...
    <title>Landlord Register - BASHALAGBE?</title>
...
<body class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 flex items-center justify-center p-6">
    ...
    <div class="relative glass-effect p-8 sm:p-12 rounded-3xl shadow-2xl max-w-md w-full border border-white/20">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Join as Landlord</h2>
            <p class="text-gray-600">Start listing your properties today</p>
        </div>
        ...
        <!-- Registration Form -->
        <form method="POST" action="{{ route('landlord.register.submit') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-start">
                <input type="checkbox" required class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded mt-1">
