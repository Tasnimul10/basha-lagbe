...
<body class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        <h1 class="text-2xl font-bold mb-6 text-center">Landlord Login</h1>

        <form method="POST" action="{{ route('landlord.login.submit') }}" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('landlord.register') }}" class="text-sm text-indigo-600 hover:underline">Register</a>
